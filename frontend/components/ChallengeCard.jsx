              ...
              {challenges.map((ch) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-gray-800/70 backdrop-blur-sm rounded-xl overflow-hidden border ${
                      isCompleted
                        ? "border-green-500/20"
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        <span className="flex items-center text-xs text-yellow-200 bg-yellow-900/30 px-2 py-1 rounded">
                          <FiUsers className="mr-1" /> {ch.participants.length}{" "}
                          participants
                        </span>
                      ...
                      <div className="mb-4">
                        <div className="flex justify-between text-xs text-gray-400 mb-1">
                          <span>Progress</span>
                          <span>
                            {Math.floor((progress / 100) * ch.durationDays)}/
