...
import { createChallenge, getLeaderBoard, getMyChallenges, inviteByUsername, joinChallenge } from '../controllers/challengeController.js'
...
challengeRoute.get('/leaderboard',authMiddleware,getLeaderBoard)
